...
import { Observable, BehaviorSubject, skipWhile, debounceTime, switchMap } from 'rxjs';
...
export class TaskPageComponent implements OnInit {
  ...
  constructor(
    ...
    private api: ApiService, @Inject(TASK_STATUS) public colors:any) {
  ...
  removeTask(){
    this.api.apiProjectsTasksDelete({
